                ...
                <div className="flex-1 flex justify-center lg:justify-end lg:pr-8 xl:pr-12">
                    <div className={`transition-all duration-1000 ease-out ${showImage ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-20'}`} style={getStaggerStyle(3)}>
                        <div className="relative">
                            ...
                            <div className="absolute inset-0 rounded-full bg-gradient-to-r from-purple-400 via-blue-400 to-purple-400 opacity-20 blur-lg scale-102"></div>
                            ...
                            <div className="absolute inset-0 rounded-full bg-gradient-to-r from-purple-400 via-blue-400 to-purple-400 opacity-20 blur-md"></div>
                        </div>
                    </div>
                </div>
            </div>
